  ...
  <main class="main-content">
    ...
    <section id="customer" class="section">
      ...
      <table>
        ...
        <tbody>
          <?php
          $query = "SELECT * FROM customers_details WHERE status='active'";
            ...
            while ($row = mysqli_fetch_array($result)) {
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="./crud/view.php?userId=<?= $userId ?>" class="view-btn">View</a>
                  <!-- <a href="./crud/edit.php?userId=<?= $userId ?>" class="view-btn">Edit</a> -->
    ...
    <section id="merchant" class="section">
      ...
      <div class="merchant-grid">
        <table>
          ...
          <tbody>
            <?php
            $query = "SELECT * FROM merchant_details WHERE status='active'";
            $result = mysqli_query($connect, $query);
            ...
            if (mysqli_num_rows($result) > 0) {
              while ($row = mysqli_fetch_assoc($result)) {
                ...
                <tr>
                  ...
                  <td><?php echo $phone; ?></td>
                  <td>
                    <a href="./crud/view.php?userId=<?php echo $userId; ?>" class="view-btn">View</a>
                    <form action="./crud/process.php" method="POST" style="display:inline-block;">
              ...
              echo '<tr><td colspan="5">No Merchants Found</td></tr>';
            }
            ?>
          </tbody>
        </table>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>Krishna</td>
            <td>Manager</td>
            <td>krishna@retrocart.com</td>
          </tr>
          <tr>
            <td>2</td>
            <td>Meena</td>
            <td>Support</td>
            <td>meena@retrocart.com</td>
          </tr>
        </tbody>
      </table>
    </section>
